    ...
    <>
      ...
      "
        >
          ...
          <form className="h-[60px] border-0 rounded-[15px] w-full p-[10px] my-0  text-[14px] text-center md:m">
            <input
              className="h-[60px] rounded-[15px] border-none w-[100%] p-[10px] my-0 mx[20px] text-[14px] text-center"
              type="text"
              placeholder="Search"
              id="search"
            />
          ...
          md:justify-end md:py-0 mt-[10px]"
          >
            ...
            <li id="cart" className="w-[50px] h-[50px]">
              <a className="w-[50px] h-[50px]" href="./cart">
                <img
                  className="w-[50px] h-[50px] p-[10px]"
        ...
        <nav
          id="navbar"
          className="w-full lg-w[1024px] px-[25px] py-[20px] gap-3 flex justify-between list-none text-[14px] bg-[#ff3b3c]"
        >
